  ...
  <div class="max-w-7xl mx-auto py-8 px-4">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-8 mb-8 text-white">
      ...
      <div class="flex gap-4">
        ...
        <a href="#leaderboard" class="bg-white text-indigo-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-100">View
          Leaderboard</a>
      </div>
    </div>
          ...
          <?php foreach ($incompleteGames as $game): ?>
            <div class="game-card p-6">
              ...
              <div class="flex gap-2">
                <a href="index.php?continue=<?= $game['id'] ?>"
                  class="btn-primary text-white px-4 py-2 rounded-lg text-sm font-bold">Continue</a>
                <button onclick="confirmAbandon(<?= $game['id'] ?>)"
                  class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg text-sm font-bold hover:bg-gray-300">Abandon</button>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
    ...
    <div id="leaderboard" class="mb-12">
        ...
        <table class="w-full">
          ...
          <tbody>
            <?php foreach ($leaderboard as $index => $player): ?>
              <tr
                class="leaderboard-item border-t border-gray-200 <?= $player['username'] === $_SESSION['username'] ? 'bg-blue-50' : 'hover:bg-gray-50' ?>">
      ...
      <div class="mt-4 text-center">
        <a href="leaderboard.php" class="btn-secondary text-white px-6 py-2 rounded-lg font-bold inline-block">View Full
          Leaderboard</a>
      </div>
    </div>
  </div>
